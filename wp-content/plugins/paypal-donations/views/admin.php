...
<div class="wrap">
    ...
    <div style="background:#FFF6D5;border: 1px solid #D1B655;color: #3F2502;margin: 10px 0;padding: 5px 5px 5px 10px;text-shadow: 1px 1px #FFFFFF;">
        ...
        <p>
            If you want to accept donations and payments using PayPal's fast and easy Express Checkout API, try our free <a href="https://wordpress.org/plugins/wp-express-checkout/" target="_blank">WP Express Checkout</a> plugin.
        </p>
    </div>
